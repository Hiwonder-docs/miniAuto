...
Follow the steps in [2.Set Arduino Environment/2.2 Arduino IDE Instruction](https://docs.hiwonder.com/projects/miniAuto/en/latest/docs/2.Set_Arduino_Environment.html#arduino-ide-instruction) to import the .zip library file located in [Default Program/app_control]() into the Arduino IDE.

If the [FastLED-master.zip]() library has already been imported previously, you may skip this step.
...
Please go to [4. App Control]() to view the program results.