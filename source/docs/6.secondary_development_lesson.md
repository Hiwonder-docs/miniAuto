...
## <span class="mark">6.1 Secondary Development Library File Introduction</span>
...
<span class="mark">How to modify the color gradient of an RGB LED in the distance between 80 and 180mm from red to yellow？</span>

<span class="mark">Please refer to the following steps:</span>

(1) Find mapping instructions in the program for controlling the RGB lights to change with the change of the distance. S<span class="mark">et R in RGB elements to change as the change of “s” by “map” function.</span> “map (distance, 80, 180, 0, 255)” maps the obstacle distance to the R element.
...
(2) <span class="mark">Change the value of the G element to be the same as the value of the A element. Note that the range of color elements is 0 to 255. Next, download the program again. The closer the obstacle is,</span> the <span class="mark">more the proportion of red and the less proportion of green. The RGB light displays yellow.
...
In this section, you can learn to detect the distance of obstacle through <span class="mark">glowing ultrasonic module. The robot car can be simultaneously controlled to turn right to avoid obstacle.</span> In this section, you'll use a glowing ultrasonic sensor to detect the distance of an obstacle and control the car to move forward or backward accordingly.
...
(1) Locate and open the <span class="mark">ultrasonic_avoid</span> program file (found in the same directory as this tutorial).
...
(4) Click <img class="common_img" src="../_static/media/chapter_6/section_7/media/image7.png"  /> to compile and upload the program. Wait for the upload to complete.
...
<img class="common_img" src="../_static/media/chapter_6/section_7/media/image22.png"   />

<img class="common_img" src="../_static/media/chapter_6/section_7/media/image23.png"   />
...
<span class="mark">In this section, the 4-channel line follower is used to detect black lines, enabling the robot car to follow the path. If the ultrasonic sensor detects a pedestrian on the line during operation, the car will automatically take evasive action to avoid the obstacle.</span>
...
Once the modification is complete, follow the [6.9.3 Program Download]() section to upload the updated program.
...
(1) Locate and open the [app_control\app_control.ino]() program file (found in the same directory as this tutorial).
...
Please access “[4. App Control]()” to view the program outcome.
